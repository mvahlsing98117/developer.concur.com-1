...
* [Retrieve a swagger documentation](#retrieve-swagger-documentation)
* [Retrieve supported resource types](#retrieve-ResourceTypes)
...
POST creates one or more provisioning request using the /Bulk endpoint. 
...
### Request
```shell
POST https://www.us.api.concursolutions.com.com/provisioning/v4/Bulk/
```
#### URI
```shell
...
### Request
```shell
POST https://www.us.api.concursolutions.com.com/provisioning/v4/Users/
```
#### URI
```shell
...
### <a name="create-users-provision-patch-request"></a> Using PATCH and the /Users endpoint for managing identity data
...
### Request 
```shell
PATCH https://www.us.api.concursolutions.com.com/provisioning/v4/Users/<Concur UUID>
```
...
### Request Example
```shell
PATCH https://www.us.api.concursolutions.com.com/provisioning/v4/Users/8f545a90-305f-441b-91cd-a69ad5f548f5
```
...
### <a name="create-users-provision-put-request></a> Using PUT and the /Users endpoint for managing identity data
...
### Request 
```shell
PUT https://www.us.api.concursolutions.com.com/provisioning/v4/Users/<Concur UUID>
```
...
### Request Example
```shell
PUT https://www.us.api.concursolutions.com.com/provisioning/v4/Users/8f545a90-305f-441b-91cd-a69ad5f548f5
```
...
## <a name="retrieve-swagger-documentation"></a>Retrieve swagger documentation

Retrieves copy of swagger documentation for user provisioning.
...
### Request
```shell
GET /provisioning/v4/swagger
```

#### Request Example
```shell
GET https://www.us.api.concursolutions.com/provisioning/v4/swagger
...
### Response Example
> This is an limited example of a swagger response request.
...
## <a name="retrieve-ResourceTypes"></a>Retrieve supported resource types 
...
### Response Example
> This is an example of a ResourceTypes response.
...
```
**************************************************
## <a name="retrieve-Schemas"></a>Retrieve supported schema 

Retrieves Concur supported schema.  Please see below for further schema information
...
### Response Example
> This is an limited example of a schema request response.
